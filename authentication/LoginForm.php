  ...
  <div class="pg-left" id="pgLeft">
    ...
    <div class="pg-left-content" id="leftContent">
      ...
      <button class="pg-signup-btn" id="signupBtn">
        <span><a href="signupForm.php" class="text-decoration-none">Create Account</a></span>
      ...
      <div class="pg-field" id="fEmail">
        ...
        <div class="pg-input-wrap">
          <svg class="icon" viewBox="0 0 20 20" fill="none">
            <path d="M2 5.5A1.5 1.5 0 013.5 4h13A1.5 1.5 0 0118 5.5v9A1.5 1.5 0 0116.5 16h-13A1.5 1.5 0 012 14.5v-9z" stroke="white" stroke-width="1.4"/>
